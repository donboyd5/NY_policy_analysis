...
Here's the preamble to A.4454 (everything through the enacting clause). It tells us the bill number, the 2-year legislative session, the house, the introduction date, the main sponsor and multi-sponsors, the law being amended, the subject, and the enacting clause. A.4454 was introduced in the first year of the 2023-2024 session by Assemblymember Hunter, with about 40 multi-sponsors and it amends only the Real Property Law. With work, we could determine how many cosponsors were Democrats, how many were Republicans, and where they are from, among other things.

![](images/clipboard-4110516660.png)

### Body of the bill

Start by getting an overview. A.4454 has three sections:

-   **Section 1** amends the Real Property Law to add a new Article 6-A, PROHIBITION OF EVICTION WITHOUT GOOD CAUSE. The section adds 7 sections to the Real Property Law and runs about 3 pages.

-   **Section 2** is a *severability clause*, which says, in essence, that if any part of the bill as enacted is found invalid (e.g., unconstitutitonal), other provisions will not be invalidated. (Severability is a general principle of statutory construction and a court might sever an invalidated clause from the rest of an enactment even in absence of a severability clause.)

-   **Section 3** is the effective date and says, "This act shall take effect immediately and shall apply to actions and proceedings commenced on or after such effective date." This might require analysis as we get into the bill in depth.

Now we dive into section 1 in depth. It adds 7 sections, not all of which are obvious from their names

![](images/clipboard-3274177729.png)

New Section 210 of the Real Property Law is obvious so we won't worry about that. Let's look at Section 211 Definitions:

-   **Housing accommodation**: "any residential premises, including a mobile home land in a mobile home park". It seems to include anything we would think of as a residence - presumably apartments, condominiums, cooperative apartments, duplexes, free standing homes, mobile homes, and even land in a mobile home park that doesn't have a home on it. We may need to investigate this more deeply later.
